...
8. 32 个 raw boxes 经 score 排序与 Pose NMS 后输出最多 16 个 placement boxes。
...
- Stage 2 的粗区域仅由 P3 与 `text_global` 预测。
- Anchor 来自 top-8 P3 cells 覆盖的 P1 active voxels，最多 32 个 Query。
